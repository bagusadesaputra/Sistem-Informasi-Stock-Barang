...
if (isset($_GET['id'])) {
    ...
    if ($data) {
        ...
        $keterangan  = $data['keterangan']; // kolom baru
    ...
    echo "<script>alert('ID tidak diberikan'); window.location='keluar.php';</script>";
    exit;
}
?>
<!DOCTYPE html>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="masuk.php">Barang Keluar</a></li>
                                ...
                                <form method="post">
                                    ...
                                    <select name="petugas" class="form-control" required>
                                        ...
                                        <?php while ($p = mysqli_fetch_array($data_petugas)) {
                                            $selected = ($p['namapetugas'] == $data['petugas']) ? 'selected' : '';
                                        ?>
                                            <option value="<?= $p['namapetugas'] ?>" <?= $selected ?>><?= $p['namapetugas'] ?></option>
                                        <?php } ?>
                                    </select>
                                    <br>
                                    <button type="submit" class="btn btn-warning" name="editkeluar">Update</button>
                                </form>
                            </div>
                        </div>
                    </div>
