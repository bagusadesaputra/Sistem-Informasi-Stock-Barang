...
<html lang="en">
    <head>
        ...
        <title>Tambah Barang Reject</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="reject.php">Barang Reject</a></li>
                            <li class="breadcrumb-item"><strong>Tambah</strong></li>
                        </ol>
                        <div class="card shadow mb-4">
                            <div class="card-header">Tambah Barang Reject</div>
                                <div class="card-body">
                                    <form method="post">
                                        <label>Barcode</label>
                                        ...
                                        <br>
                                        <button type="submit" class="btn btn-primary" name="tambahbarangreject">Submit</button>
                                    </form>
                                </div>
                        </div>
                    </div>
