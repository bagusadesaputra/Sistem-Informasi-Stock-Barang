                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="lokasi.php">Lokasi Barang</a></li>
                            <li class="breadcrumb-item"><strong>Tambah</strong></li>
                        </ol>
                        <div class="card shadow mb-4">
                            <div class="card-header">Tambah Lokasi Barang</div>
                                <div class="card-body">
                                    <form method="post">
                                        <label>Nama Lokasi</label>
                                        <input type="text" id="lokasi" name="lokasi" class="form-control" required>
                                        <br>
                                        <button type="submit" class="btn btn-primary" name="tambahlokasi">Submit</button>
                                    </form>
                                </div>
                        </div>
                    </div>
